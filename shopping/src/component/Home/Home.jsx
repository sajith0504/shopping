...
// import  img from '../../../public/assets/frontend/frontend/images/country/united-states.png'
// ./assets/frontend/images/country/united-states.png
const Home = () => {
  return (
        ...
        <div className="row g-4">
            <div className="col-xxl-3 col-lg-4 col-sm-6 ratio_180 d-sm-block d-none">
                <div className="home-contain rounded">
                    <div className="h-100">
                        <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/banner/1.jpg`} className="bg-img blur-up lazyload" alt=""/>
                    </div>
                    <div className="home-detail p-top-left home-p-medium">
                        <div>
                            ...
                            <p className="text-content d-md-block d-none">Bento box burritos cherry bomb pepper dark
                                and
            ...
            <div className="col-xxl-6 col-lg-8 order-xxl-0 ratio_87">
                <div className="home-contain rounded">
                    <div className="h-100">
                        <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/banner/2.jpg`} className="bg-img blur-up lazyload" alt=""/>
                    </div>
            ...
            <div
                ...
                <div className="home-contain rounded">
                    <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/banner/3.jpg`} className="bg-img blur-up lazyload" alt=""/>
                    <div className="home-detail p-top-left home-p-medium">
                        <div>
                            <h6 className="text-danger mb-2 fw-bold">Fresh & Delicious</h6>
                            <h2 className="theme-color fw-bold">Bakery Sweet</h2>
                            <p className="text-content d-md-block d-none">Peanut butter crunch chia seeds red
                                parsley
                                basil overflowing..</p>
                            <a href="shop-left-sidebar.html" className="shop-button">Shop Now <i
                                    className="fa-solid fa-right-long ms-2"></i></a>
        ...
        <div className="row">
            <div className="col-12">
                <div className="slider-9">
                    <div>
                        <a href="shop-left-sidebar.html" className="category-box category-box-2 category-dark">
                            <div>
                                <img src={`${process.env.PUBLIC_URL}/assets/frontend/svg/2/1.svg`} className="blur-up lazyload" alt=""/>
                                <h5>Cake</h5>
                            </div>
                        </a>
                    </div>
                    ...
                    <div>
                        <a href="shop-left-sidebar.html" className="category-box category-box-2 category-dark"
                            data-wow-delay="0.2s">
                            <div>
                                <img src={`${process.env.PUBLIC_URL}/assets/frontend/svg/2/2.svg`} className="blur-up lazyload" alt=""/>
                                <h5>Sandwich</h5>
                            </div>
                        </a>
                    </div>
                    ...
                    <div>
                        <a href="shop-left-sidebar.html" className="category-box category-box-2 category-dark"
                            data-wow-delay="0.3s">
                            <div>
                                <img src={`${process.env.PUBLIC_URL}/assets/frontend/svg/2/3.svg`} className="blur-up lazyload" alt=""/>
                                <h5>Cookies</h5>
                            </div>
                        </a>
                    </div>
                    ...
                    <div>
                        <a href="shop-left-sidebar.html" className="category-box category-box-2 category-dark"
                            data-wow-delay="0.4s">
                            <div>
                                <img src={`${process.env.PUBLIC_URL}/assets/frontend/svg/2/4.svg`} className="blur-up lazyload" alt=""/>
                                <h5>Pie</h5>
                            </div>
                        </a>
                    </div>
                    ...
                    <div>
                        <a href="shop-left-sidebar.html" className="category-box category-box-2 category-dark"
                            data-wow-delay="0.5s">
                            <div>
                                <img src={`${process.env.PUBLIC_URL}/assets/frontend/svg/2/5.svg`} className="blur-up lazyload" alt=""/>
                                <h5>Bread</h5>
                            </div>
                        </a>
                    </div>
                    ...
                    <div>
                        <a href="shop-left-sidebar.html" className="category-box category-box-2 category-dark"
                            data-wow-delay="0.6s">
                            <div>
                                <img src={`${process.env.PUBLIC_URL}/assets/frontend/svg/2/6.svg`} className="blur-up lazyload" alt=""/>
                                <h5>Biscuits</h5>
                            </div>
                        </a>
                    </div>
                    ...
                    <div>
                        <a href="shop-left-sidebar.html" className="category-box category-box-2 category-dark"
                            data-wow-delay="0.7s">
                            <div>
                                <img src={`${process.env.PUBLIC_URL}/assets/frontend/svg/2/7.svg`} className="blur-up lazyload" alt=""/>
                                <h5>Bagel</h5>
                            </div>
                        </a>
                    </div>
                    ...
                    <div>
                        <a href="shop-left-sidebar.html" className="category-box category-box-2 category-dark"
                            data-wow-delay="0.8s">
                            <div>
                                <img src={`${process.env.PUBLIC_URL}/assets/frontend/svg/2/8.svg`} className="blur-up lazyload" alt=""/>
                                <h5>Croissant</h5>
                            </div>
                        </a>
                    </div>
                    ...
                    <div>
                        <a href="shop-left-sidebar.html" className="category-box category-box-2 category-dark"
                            data-wow-delay="0.9s">
                            <div>
                                <img src={`${process.env.PUBLIC_URL}/assets/frontend/svg/2/9.svg`} className="blur-up lazyload" alt=""/>
                                <h5>Cupcake</h5>
                            </div>
                        </a>
                    </div>
    ...
    <div className="container-fluid-lg">
        <div className="row g-3">
            <div className="col-xxl-3 col-sm-6">
                <a href="shop-left-sidebar.html" className="banner-contain-2 hover-effect">
                    <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/banner/5.jpg`} className="bg-img blur-up lazyload" alt=""/>
            ...
            <div className="col-xxl-3 col-sm-6">
                <a href="shop-left-sidebar.html" className="banner-contain-2 hover-effect">
                    <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/banner/6.jpg`} className="bg-img blur-up lazyload" alt=""/>
                    <div className="banner-detail p-top-left">
                        <div>
                            <div className="banner-detail-box mb-md-3 mb-1">
                                <h6 className="text-danger">5% OFF</h6>
            ...
            <div className="col-xxl-3 col-sm-6">
                <a href="shop-left-sidebar.html" className="banner-contain-2 hover-effect">
                    <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/banner/7.jpg`} className="bg-img blur-up lazyload" alt=""/>
                    <div className="banner-detail p-top-left">
                        <div>
                            <div className="banner-detail-box mb-md-3 mb-1">
                                <h6 className="text-danger">5% OFF</h6>
            ...
            <div className="col-xxl-3 col-sm-6">
                <a href="shop-left-sidebar.html" className="banner-contain-2 hover-effect">
                    <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/banner/8.jpg`} className="bg-img blur-up lazyload" alt=""/>
                    <div className="banner-detail p-top-left">
                        <div>
                            <div className="banner-detail-box mb-md-3 mb-1">
                                <h6 className="text-danger">5% OFF</h6>
            ...
            <div className="col-xxl-9 col-xl-8">
                ...
                <div className="product-box-slider-2 no-arrow">
                    <div>
                        <div className="product-box product-box-bg wow fadeInUp">
                            <div className="product-image">
                                <a href="product-left-thumbnail.html">
                                    <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/product/1.png`}
                        ...
                        <div className="product-box product-box-bg wow fadeInUp" data-wow-delay="0.1s">
                            <div className="product-image">
                                <a href="product-left-thumbnail.html">
                                    <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/product/2.png`}
                                        className="img-fluid blur-up lazyload" alt=""/>
                                </a>
                                <ul className="product-option">
                                    <li data-bs-toggle="tooltip" data-bs-placement="top" title="View">
                    ...
                    <div>
                        <div className="product-box product-box-bg wow fadeInUp">
                            <div className="product-image">
                                <a href="product-left-thumbnail.html">
                                    <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/product/3.png`}
                                        className="img-fluid blur-up lazyload" alt=""/>
                                </a>
                                <ul className="product-option">
                                    <li data-bs-toggle="tooltip" data-bs-placement="top" title="View">
                        ...
                        <div className="product-box product-box-bg wow fadeInUp" data-wow-delay="0.1s">
                            <div className="product-image">
                                <a href="product-left-thumbnail.html">
                                    <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/product/4.png`}
                                        className="img-fluid blur-up lazyload" alt=""/>
                                </a>
                                <ul className="product-option">
                                    <li data-bs-toggle="tooltip" data-bs-placement="top" title="View">
                    ...
                    <div>
                        <div className="product-box product-box-bg wow fadeInUp">
                            <div className="product-image">
                                <a href="product-left-thumbnail.html">
                                    <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/product/5.png`}
                                        className="img-fluid blur-up lazyload" alt=""/>
                                </a>
                                <ul className="product-option">
                                    <li data-bs-toggle="tooltip" data-bs-placement="top" title="View">
                        ...
                        <div className="product-box product-box-bg wow fadeInUp" data-wow-delay="0.1s">
                            <div className="product-image">
                                <a href="product-left-thumbnail.html">
                                    <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/product/6.png`}
                                        className="img-fluid blur-up lazyload" alt=""/>
                                </a>
                                <ul className="product-option">
                                    <li data-bs-toggle="tooltip" data-bs-placement="top" title="View">
                    ...
                    <div>
                        <div className="product-box product-box-bg wow fadeInUp">
                            <div className="product-image">
                                <a href="product-left-thumbnail.html">
                                    <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/product/7.png`}
                                        className="img-fluid blur-up lazyload" alt=""/>
                                </a>
                                <ul className="product-option">
                                    <li data-bs-toggle="tooltip" data-bs-placement="top" title="View">
                        ...
                        <div className="product-box product-box-bg wow fadeInUp" data-wow-delay="0.1s">
                            <div className="product-image">
                                <a href="product-left-thumbnail.html">
                                    <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/product/8.png`}
                                        className="img-fluid blur-up lazyload" alt=""/>
                                </a>
                                <ul className="product-option">
                                    <li data-bs-toggle="tooltip" data-bs-placement="top" title="View">
                    ...
                    <div>
                        <div className="product-box product-box-bg wow fadeInUp">
                            <div className="product-image">
                                <a href="product-left-thumbnail.html">
                                    <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/product/9.png`}
                                        className="img-fluid blur-up lazyload" alt=""/>
                                </a>
                                <ul className="product-option">
                                    <li data-bs-toggle="tooltip" data-bs-placement="top" title="View">
                        ...
                        <div className="product-box product-box-bg wow fadeInUp" data-wow-delay="0.1s">
                            <div className="product-image">
                                <a href="product-left-thumbnail.html">
                                    <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/product/10.png`}
                                        className="img-fluid blur-up lazyload" alt=""/>
                                </a>
                                <ul className="product-option">
                                    <li data-bs-toggle="tooltip" data-bs-placement="top" title="View">
                ...
                <div className="slider-3_2 product-wrapper">
                    <div>
                        <div className="product-box-2 wow fadeIn">
                            <a href="product-left-thumbnail.html" className="product-image">
                                <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/pro/1.jpg`} className="img-fluid blur-up lazyload"
                                    alt=""/>
                            </a>
                        ...
                        <div className="product-box-2 wow fadeIn" data-wow-delay="0.1s">
                            <a href="product-left-thumbnail.html" className="product-image">
                                <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/pro/2.jpg`} className="img-fluid blur-up lazyload"
                                    alt=""/>
                            </a>
                        ...
                        <div className="product-box-2 wow fadeIn" data-wow-delay="0.2s">
                            <a href="product-left-thumbnail.html" className="product-image">
                                <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/pro/3.jpg`} className="img-fluid blur-up lazyload"
                                    alt=""/>
                            </a>
                    ...
                    <div>
                        <div className="product-box-2 wow fadeIn">
                            <a href="product-left-thumbnail.html" className="product-image">
                                <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/pro/4.jpg`} className="img-fluid blur-up lazyload"
                                    alt=""/>
                            </a>
                        ...
                        <div className="product-box-2 wow fadeIn" data-wow-delay="0.1s">
                            <a href="product-left-thumbnail.html" className="product-image">
                                <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/pro/5.jpg`} className="img-fluid blur-up lazyload"
                                    alt=""/>
                            </a>
                        ...
                        <div className="product-box-2 wow fadeIn" data-wow-delay="0.2s">
                            <a href="product-left-thumbnail.html" className="product-image">
                                <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/pro/6.jpg`} className="img-fluid blur-up lazyload"
                                    alt=""/>
                            </a>
                ...
                <div className="product-box-slider-2 no-arrow">
                    <div>
                        ...
                        <div className="product-box product-box-bg wow fadeIn" data-wow-delay="0.1s">
                            <div className="product-image">
                                <a href="product-left-thumbnail.html">
                                    <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/product/2.png`}
                                        className="img-fluid blur-up lazyload" alt=""/>
                ...
                <div className="position-sticky top-0">
                    <div className="ratio_209 rounded wow fadeIn">
                        <div className="banner-contain-2 rounded hover-effect">
                            <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/banner/10.jpg`} className="bg-img blur-up lazyload"
                                alt=""/>
                            <div className="banner-detail p-top-left">
                                <div>
                    ...
                    <div className="ratio_125 section-t-space wow fadeIn">
                        <div className="banner-contain-2 rounded hover-effect">
                            <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/banner/9.jpg`} className="bg-img blur-up lazyload"
                                alt=""/>
                            <div className="banner-detail p-top-left">
                                <div>
                                    <h6 className="text-uppercase theme-color fw-500">Freash Every Day!</h6>
                                    <h3 className="text-pacifico mt-2">Delicioud <span
                                            className="theme-color">Bread</span>
                                    </h3>
                                    <p className="text-content fw-500 mt-3 w-75 mend-auto">Delicioud Bread and Brend
                                        new
                                        fresh bread.</p>
                                    <button onclick="location.href = 'shop-left-sidebar.html';"
                            ...
                            <div className="review-box">
                                ...
                                <div className="review-profile">
                                    <div className="review-image">
                                        <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/vegetable/review/1.jpg`}
                                            className="img-fluid blur-up lazyload" alt=""/>
                                    </div>
        ...
        <div className="row">
            <div className="col-12">
                <div className="home-contain hover-effect">
                    <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/banner/11.jpg`} className="bg-img blur-up lazyload" alt=""/>
                        ...
                        <div className="top-selling-box">
                            ...
                            <div className="top-selling-contain wow fadeInUp">
                                <a href="product-left-thumbnail.html" className="top-selling-image">
                                    <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/pro/1.jpg`}
                                        className="img-fluid blur-up lazyload" alt=""/>
                                </a>
                            ...
                            <div className="top-selling-contain wow fadeInUp" data-wow-delay="0.5s">
                                <a href="product-left-thumbnail.html" className="top-selling-image">
                                    <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/pro/2.jpg`}
                                        className="img-fluid blur-up lazyload" alt=""/>
                                </a>
                            ...
                            <div className="top-selling-contain wow fadeInUp" data-wow-delay="0.5s">
                                <a href="product-left-thumbnail.html" className="top-selling-image">
                                    <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/pro/3.jpg`}
                                        className="img-fluid blur-up lazyload" alt=""/>
                                </a>
                ...
                <div className="row">
                    <div className="col-12">
                        <div className="top-selling-box">
                            ...
                            <div className="top-selling-contain wow fadeInUp">
                                <a href="product-left-thumbnail.html" className="top-selling-image">
                                    <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/pro/5.jpg`}
                                        className="img-fluid blur-up lazyload" alt=""/>
                                </a>
                            ...
                            <div className="top-selling-contain wow fadeInUp" data-wow-delay="0.2s">
                                <a href="product-left-thumbnail.html" className="top-selling-image">
                                    <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/pro/6.jpg`}
                                        className="img-fluid blur-up lazyload" alt=""/>
                                </a>
                            ...
                            <div className="top-selling-contain wow fadeInUp" data-wow-delay="0.4s">
                                <a href="product-left-thumbnail.html" className="top-selling-image">
                                    <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/pro/1.jpg`}
                                        className="img-fluid blur-up lazyload" alt=""/>
                                </a>
                ...
                <div className="row">
                    <div className="col-12">
                        <div className="top-selling-box">
                            ...
                            <div className="top-selling-contain wow fadeInUp">
                                <a href="product-left-thumbnail.html" className="top-selling-image">
                                    <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/pro/4.jpg`}
                                        className="img-fluid blur-up lazyload" alt=""/>
                                </a>
    ...
    <div className="container-fluid-lg">
                    ...
                    <div className="service-contain">
                        <div className="service-box">
                            <div className="service-image">
                                <img src={`${process.env.PUBLIC_URL}/assets/frontend/svg/product.svg`} className="blur-up lazyload" alt=""/>
                            </div>
                        ...
                        <div className="service-box">
                            <div className="service-image">
                                <img src={`${process.env.PUBLIC_URL}/assets/frontend/svg/delivery.svg`} className="blur-up lazyload" alt=""/>
                            </div>
                        ...
                        <div className="service-box">
                            <div className="service-image">
                                <img src={`${process.env.PUBLIC_URL}/assets/frontend/svg/discount.svg`} className="blur-up lazyload" alt=""/>
                            </div>
                        ...
                        <div className="service-box">
                            <div className="service-image">
                                <img src={`${process.env.PUBLIC_URL}/assets/frontend/svg/market.svg`} className="blur-up lazyload" alt=""/>
                            </div>
                ...
                <div className="col-xl-3 col-lg-4 col-sm-6">
                    <div className="footer-logo">
                        <div className="theme-logo">
                            <a href="index.html">
                                <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/logo/2.png`} className="blur-up lazyload" alt=""/>
                            </a>
                        </div>
                                ...
                                <ul>
                                    <li className="mb-0">
                                        <a href="https://play.google.com/store/apps" target="_blank">
                                            <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/playstore.svg`} className="blur-up lazyload"
                                                alt=""/>
                                        </a>
                                    </li>
                                    <li className="mb-0">
                                        <a href="https://www.apple.com/in/app-store/" target="_blank">
                                            <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/appstore.svg`} className="blur-up lazyload"
                                                alt=""/>
                                        </a>
                                    </li>
                                </ul>
        ...
        <div className="sub-footer section-small-space">
            ...
            <div className="payment">
                <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/payment/1.png`} className="blur-up lazyload" alt=""/>
            </div>
                ...
                <div className="row g-sm-4 g-2">
                    <div className="col-lg-6">
                        <div className="slider-image">
                            <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/product/category/1.jpg`}
                                className="img-fluid blur-up lazyload" alt=""/>
                        </div>
                    </div>
                ...
                <div className="deal-offer-box">
                    <ul className="deal-offer-list">
                        <li className="list-1">
                            <div className="deal-offer-contain">
                                <a href="shop-left-sidebar.html" className="deal-image">
                                    <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/vegetable/product/10.png`}
                        ...
                        <li className="list-2">
                            <div className="deal-offer-contain">
                                <a href="shop-left-sidebar.html" className="deal-image">
                                    <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/vegetable/product/11.png`}
                                        className="blur-up lazyload" alt=""/>
                                </a>
                        ...
                        <li className="list-3">
                            <div className="deal-offer-contain">
                                <a href="shop-left-sidebar.html" className="deal-image">
                                    <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/vegetable/product/12.png`}
                                        className="blur-up lazyload" alt=""/>
                                </a>
                        ...
                        <li className="list-1">
                            <div className="deal-offer-contain">
                                <a href="shop-left-sidebar.html" className="deal-image">
                                    <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/vegetable/product/13.png`}
                                        className="blur-up lazyload" alt=""/>
                                </a>
...
<div className="add-cart-box">
    <div className="add-image">
        <img src={`${process.env.PUBLIC_URL}/assets/frontend/images/cake/pro/1.jpg`} className="img-fluid blur-up lazyload" alt=""/>
    </div>
