                    ...
                    <div className="header-nav-left">
                        ...
                        <div className="category-dropdown">
                            ...
                            <ul className="category-list">
                                ...
                                <li className="onhover-category-list">
                                    <a href="javascript:void(0)" className="category-name">
                                        <img src={`${process.env.PUBLIC_URL}/assets/frontend/svg/1/cup.svg`} alt=""/>
                                        <h6>Beverages</h6>
                                        <i className="fa-solid fa-angle-right"></i>
                                    </a>
                                ...
                                <li className="onhover-category-list">
                                    <a href="javascript:void(0)" className="category-name">
                                        <img src={`${process.env.PUBLIC_URL}/assets/frontend/svg/1/meats.svg`} alt=""/>
                                        <h6>Meats & Seafood</h6>
                                        <i className="fa-solid fa-angle-right"></i>
                                    </a>
                                ...
                                <li className="onhover-category-list">
                                    <a href="javascript:void(0)" className="category-name">
                                        <img src={`${process.env.PUBLIC_URL}/assets/frontend/svg/1/breakfast.svg`} alt=""/>
                                ...
                                <li className="onhover-category-list">
                                    <a href="javascript:void(0)" className="category-name">
                                        <img src={`${process.env.PUBLIC_URL}/assets/frontend/svg/1/frozen.svg`} alt=""/>
                                        <h6>Frozen Foods</h6>
                                        <i className="fa-solid fa-angle-right"></i>
                                    </a>
                                ...
                                <li className="onhover-category-list">
                                    <a href="javascript:void(0)" className="category-name">
                                        <img src={`${process.env.PUBLIC_URL}/assets/frontend/svg/1/biscuit.svg`} alt=""/>
                                ...
                                <li className="onhover-category-list">
                                    <a href="javascript:void(0)" className="category-name">
                                        <img src={`${process.env.PUBLIC_URL}/assets/frontend/svg/1/grocery.svg`} alt=""/>
