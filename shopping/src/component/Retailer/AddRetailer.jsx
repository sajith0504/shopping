...
const AddRetailer = () => {
  ...
  useEffect(() => {
    if (loggedInUser.role === "Superadmin" || loggedInUser.role === "admin" || loggedInUser.role === "distributor")
        {
    ...
    if (loggedInUser.role === "Superadmin" || loggedInUser.role === "admin" || loggedInUser.role === "distributor") {
      try {
        ...
        if (response.status === 201) {
          ...
          navigate("/addretailer"); // Update with the desired path
        } else {
          alert("Error: Failed to add retailer.");
        }
      } catch (error) {
        if (error.response) {
                ...
                <div className="col-sm-8 m-auto">
                  <div className="card">
                    <div className="card-body">
                      ...
                      {loggedInUser.role === "Superadmin" || loggedInUser.role ==="admin" || loggedInUser.role ==="distributor" ? (
                        <form
